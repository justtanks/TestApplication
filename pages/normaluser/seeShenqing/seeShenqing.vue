...
<template>
	<view>
		...
		<view class="timechoise uni-list-cell-navigate uni-navigate-right"> 
			...
			<input style="line-height: 1; font-size: 35upx;" placeholder="请输入姓名,2-8个字符" maxlength="8" v-model="zhengmingren" />
		</view>
		...
		<view style="height: 60upx;width: auto;margin: 20upx 45upx 120upx 45upx;" >
			<button  class="buttonstyle"  @click="addshenqing" >重新提交</button>
		</view>
		<!-- 分别是时间选择控件，和列表选择控件 -->
...
<style>
	...
	.zhuangtai{
		height: 100upx;display: flex; flex-direction: column;
		margin: 10upx 35upx;
		padding-top: 20upx;
